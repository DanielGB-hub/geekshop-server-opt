...
#        db_profile_by_type('learn db', '', connection.queries)
        ...
        action_2__condition = Q(order__updated_at__gt=F('order__created_at') + action_1__time_delta) & Q(order__updated_at__lte=F('order__created_at') + action_2__time_delta)
